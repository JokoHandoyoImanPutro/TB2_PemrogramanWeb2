...
<div class="wrapper">
    ...
    if (count($mahasiswas) > 0) {
        foreach ($mahasiswas as $index => $data) {
    ?>
            <div class="intro">
                <div class="profile">
                    <div class="photo">
                    ...
                    <div class="bio">
                        ...
                        <p class="profession"><?= $data['profesi']; ?></p>
                        <hr />
                    </div>
                </div>
                ...
                <div class="intro-section contact">
                    ...
                    <div class="info-section">
                        ...
                        <span>No. Telephone : <?= $data['telephone']; ?></span>
                    </div>
                    <div class="info-section">
                        <i class="fas fa-map-marker-alt"></i>
                        <span>Alamat Rumah : <?= $data['alamat']; ?></span>
                    </div>
                    <div class="info-section">
                ...
                <div class="intro-section contact">
                    ...
                    <div class="info-section">
                        ...
                        <span>Asal Universitas/Sekolah : <?= $data['namasekolah']; ?></span>
                    </div>
                    <div class="info-section">
                        <i class="fas fa-map-marker-alt"></i>
                        <span>Pendidikan : <?= $data['pendidikan']; ?></span>
                    </div>
                    <div class="info-section">
                        <i class="fas fa-paper-plane"></i>
                        <span>Jurusan : <?= $data['jurusan']; ?></span>
                    </div>
                </div>
                <div class="intro-section contact">
                    ...
                    <div class="info-section">
                        <i class="fas fa-phone"></i>
                        <span>Pengalaman : <?= $data['pengalaman']; ?></span>
                    </div>
                    <div class="info-section">
                        <i class="fas fa-map-marker-alt"></i>
                        <span>Jabatan Pekerjaan : <?= $data['Jabatan']; ?></span>
                    </div>
                </div>
